...
<body>
  ...
  <div class="conteudo-main">
    <main class="tela-agendamento">
      <div class="container">
        <div class="info">
          <img class="icon-logo" src="imgs/icones/icons8-equipe-96.png" alt="" />
          <h1>Equipe NAPE</h1>
        </div>
        <div class="text">
          <h3>Gerencia todos os profissionais</h3>
        </div>
      </div> <!--fecha: container-->
    </main>

    <div class="botao-adicionar">
      <button type="button" id="bttAdd" onclick="addProfissional()">Adicionar profissional</button>
    </div>

    <section class="cards-section">
      <?php
      if (count($todosProfissionais) > 0):
        foreach ($todosProfissionais as $row): ?>
          <div class="card">
            <div class="card-text">
              <a href="dados-pessoais.php?id=<?= $row['id_profissional'] ?>">
  ...
  <div id="modalForm" class="modal">
    <div class="modal-content">
          ...
          <div class="coluna">
            <form id="addProfissionalForm" method="post" action="admin/adicionarProfissional.php">
              <div class="conjunto-info">
                <label for="nome_profissional" class="labelCadastro">Digite o nome do Profissional:</label>
              ...
              <div class="conjunto-info">
                <label for="cargo_profissional" class="labelCadastro">Digite o cargo do Profissional:</label>
              ...
              <div class="conjunto-info">
                <label for="data_nascimento" class="labelCadastro">Data de nascimento do Profissional:</label>
                <input type="date" class="inputCadastro" name="data_nascimento" required>
              </div>

              <div class="conjunto-info">
                <label for="Contato" class="labelCadastro">Contato do profissional:</label>
                <input type="tel" class="inputCadastro" name="contato" placeholder="(00) 0000-0000" maxlength="10" required>
              </div>
      ...
      <div class="modal-actions">
        <button type="submit" class="botao-agendamento" form="addProfissionalForm">Salvar</button>
