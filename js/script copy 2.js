document.addEventListener("DOMContentLoaded", function () {
  ...
  console.log("📄 Página detectada:", {
    ...
    isUsuarioPage: isUsuarioPage,
    isAgendamentoPage: isAgendamentoPage,
  });
  ...
  // ========== PREVIEW DE FOTOS ==========
  function setupPhotoPreview(inputId, previewId, fileNameId) {
    const fotoInput = document.getElementById(inputId);
    const fileName = document.getElementById(fileNameId);
    const preview = document.getElementById(previewId);

    if (fotoInput && fileName && preview) {
  ...
  setupPhotoPreview("foto", "preview", "fileName");
  setupPhotoPreview("fotoEdit", "previewEdit", "fileNameEdit");
